...
#define X_DUAL_STEPPER_DRIVERS // mpcnc
  ...
  #define INVERT_X2_VS_X_DIR false//Kalle //mpcnc
...
#define Y_DUAL_STEPPER_DRIVERS //mpcnc
  ...
  #define INVERT_Y2_VS_Y_DIR false//Kalle //mpcnc
...
#define HOMING_BUMP_DIVISOR {4, 4, 4}  //mpcnc Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define DEFAULT_STEPPER_DEACTIVE_TIME 0 //mpcnc //Kalle 0=>~
...
//#define LCD_TIMEOUT_TO_STATUS 15000
  ...
  #define SD_FINISHED_STEPPERRELEASE false  //mpcnc if sd support and the file is finished: disable steppers?
